...
import 'package:weight_loss_tracker/model/header.dart';
import 'package:weight_loss_tracker/model/item.dart';
import 'package:weight_loss_tracker/model/todo.dart';
import 'package:weight_loss_tracker/model/view_type.dart';
import 'package:weight_loss_tracker/weightCalculator/input_page.dart';
...
class _TodoListState extends State<TodoList> {
  ...
  Widget _createAppBar() {
    return new AppBar(
      ...
      leading: const Icon(Icons.beenhere, color:Colors.black),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.monitor_weight_rounded , color:Colors.black),
                    onPressed: () {
                      setState(() {
  ...
  List<Widget> _buildNoToDoViewItem() {
    return <Widget>[
      ...
      new Text('No List',
          style: new TextStyle(
              color: Colors.grey.withOpacity(0.4), fontSize: 16.0))
    ];
  }
  ...
  List<DropdownMenuItem<Category>> _createCatergoryDropDownMenuItems(
    ...
    List<DropdownMenuItem<Category>> menuItems = categories.map((category) {
      return new DropdownMenuItem(
          ...
          child: new Row(
            children: <Widget>[
              new Icon(category.getIcon(), color: Colors.black, size: 14.0),
              new Padding(
